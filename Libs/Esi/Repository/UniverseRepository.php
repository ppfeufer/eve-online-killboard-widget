...
class UniverseRepository extends \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Swagger {
     ...
     *
     * @return array of \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseAncestries
     */
    public function universeAncestries() {
        ...
        return $this->mapArray($this->callEsi(), '\\WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseAncestries');
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseConstellationsConstellationId
     */
    public function universeAsteroidBeltsAsteroidBeltId($asteroidBeltId) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseConstellationsConstellationId);
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseGroupsGroupId
     */
    public function universeGroupsGroupId($groupId) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseGroupsGroupId);
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseIds
     */
    public function universeIds(array $names) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseIds);
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseRegionsRegionId
     */
    public function universeRegionsRegionId($regionId) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseRegionsRegionId);
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseSystemsSystemId
     */
    public function universeSystemsSystemId($systemId) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseSystemsSystemId);
    }
     ...
     * @return \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseTypesTypeId
     */
    public function universeTypesTypeId($typeId) {
        ...
        return $this->map($this->callEsi(), new \WordPress\Plugins\EveOnlineKillboardWidget\Libs\Esi\Model\Universe\UniverseTypesTypeId);
    }
}
