...
### Protip
After this update make sure you go to your widget settings and save it again. The way the widget settings are handles has been changed slightly to improve performance.
